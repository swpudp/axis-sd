...
namespace AxisOrder.SoapMiddleware
{
    public class SoapOfMiddleware
    {
        ...
        public SoapOfMiddleware(RequestDelegate next, Type serviceType, string path, MessageEncoder encoder, IServiceProvider _serviceProvider)
        {
            _next = next;
    ...
    public static class SOAPMiddlewareExtensions
    {
        ...
        {
            return builder.UseMiddleware<SoapOfMiddleware>(typeof(T), path, encoder);
        }
